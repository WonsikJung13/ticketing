package com.limdaram.ticketing.service.kimchi;

import com.limdaram.ticketing.domain.kimchi.KimchiDto;
import com.limdaram.ticketing.mapper.kimchi.KimchiMapper;
...
//                File folder2 = new File("/Users/sunggyu-lim/Desktop/kukbi/study/upload/ticket/content/" + content.getContentId());
    ...
    public List<KimchiDto> listContent(KimchiDto KimchiDto) {
        int countAll = mapper.countAll();

        KimchiDto.setCountContent(countAll);
    ...
    public List<KimchiDto> selectContent() {
...
//            File folder = new File("/Users/sunggyu-lim/Desktop/kukbi/study/upload/ticket/content/" + content.getContentId());
    ...
    public KimchiDto reservation(int contentId) {

        return mapper.select(contentId);
    }

    public List<KimchiDto> getDetailName(int contentId) {
        return mapper.selectDetailName(contentId);
    }
    public KimchiDto get(int contentId) {
        return mapper.select(contentId);
    }
}
